...
from app.routers.dynamic_content import router_post_users
from app.routers.dynamic_content import router_login
...
app.include_router(router_post_users, prefix="/app")
app.include_router(router_login, prefix="/app")
